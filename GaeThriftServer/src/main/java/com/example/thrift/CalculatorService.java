...
public class CalculatorService {
  ...
  public interface Iface {
     ...
     * @param param2
     */
    public int div(int param1, int param2) throws com.example.thrift.TInvalidParameterException, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public int recv_div() throws com.example.thrift.TInvalidParameterException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class div_call extends org.apache.thrift.async.TAsyncMethodCall<Integer> {
      ...
      public Integer getResult() throws com.example.thrift.TInvalidParameterException, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class div<I extends Iface> extends org.apache.thrift.ProcessFunction<I, div_args> {
      ...
      public div_result getResult(I iface, div_args args) throws org.apache.thrift.TException {
        ...
        try {
          ...
          result.setSuccessIsSet(true);
        } catch (com.example.thrift.TInvalidParameterException error) {
          result.error = error;
        }
        return result;
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Integer> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Integer>() {
          ...
          public void onError(Exception e) {
            ...
            org.apache.thrift.TSerializable msg;
            div_result result = new div_result();
            if (e instanceof com.example.thrift.TInvalidParameterException) {
              result.error = (com.example.thrift.TInvalidParameterException) e;
  ...
  public static class div_result implements org.apache.thrift.TBase<div_result, div_result._Fields>, java.io.Serializable, Cloneable, Comparable<div_result>   {
    ...
    public int success; // required
    public com.example.thrift.TInvalidParameterException error; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.ERROR, new org.apache.thrift.meta_data.FieldMetaData("error", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.example.thrift.TInvalidParameterException.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public div_result(
      int success,
      com.example.thrift.TInvalidParameterException error)
    {
      this();
      this.success = success;
      setSuccessIsSet(true);
    ...
    public div_result(div_result other) {
      ...
      this.success = other.success;
      if (other.isSetError()) {
        this.error = new com.example.thrift.TInvalidParameterException(other.error);
      }
    }
    ...
    public com.example.thrift.TInvalidParameterException getError() {
      return this.error;
    }

    public div_result setError(com.example.thrift.TInvalidParameterException error) {
      this.error = error;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case ERROR:
        if (value == null) {
          ...
          setError((com.example.thrift.TInvalidParameterException)value);
        }
        break;
          ...
          switch (schemeField.id) {
            ...
            case 1: // ERROR
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.error = new com.example.thrift.TInvalidParameterException();
